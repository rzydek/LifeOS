...
const DICTIONARY: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sniper.description': 'Automated OLX market monitoring and deal analysis.',
    ...
    'sniper.scoreHelp': 'Only show results with an AI confidence score above this value.',
  ...
  pl: {
    ...
    'sniper.description': 'Automatyczne monitorowanie rynku OLX i analiza okazji.',
    ...
    'sniper.scoreHelp': 'Pokaż tylko wyniki z oceną pewności AI powyżej tej wartości.',
...
@Injectable({
  providedIn: 'root' // Singleton across the app if provided in root
})
export class I18nService {
  ...
  setLanguage(lang: Language) {
    ...
    // Persist language preference if needed (e.g. localStorage)
